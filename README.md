...
- the SSH public key to install (Enter keeps mine; accepts Ed25519, security-key
  Ed25519 or RSA of at least 3072 bits, without certificate or key options) and which users get it
